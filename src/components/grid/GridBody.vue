        ...
        div.main-grid-cell(v-for="taskItem in task" :class="taskItem.name")
            div.main-grid-cell-inner
                span.main-grid-cell-content
                    ...
                    router-link.main-grid-cell-task(:to="{ name: 'Item', params:{id:`${taskItem.value.id}`}}" v-if="taskItem.name=='title'") {{ taskItem.value.title}}
                    a.main-grid-cell-task(
                      v-else-if="taskItem.name=='creator'" )
                      img.main-grid-cell-ava(alt="avatar.png" :src="'https://cp.micros.uz'+taskItem.value.icon" v-if="taskItem.value.icon")
